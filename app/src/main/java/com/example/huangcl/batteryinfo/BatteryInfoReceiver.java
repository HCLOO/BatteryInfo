...
public class BatteryInfoReceiver extends BroadcastReceiver {
    ...
    public void initDataList() {
        ...
        dataList.add(data9);
        Data data10=new Data("BatteryMcc(最大充电电流)："+BatteryMcc);
        dataList.add(data10);
        Data data11=new Data("BatteryMcv(最大充电电压)："+BatteryMcv);
        dataList.add(data11);
        Data data12=new Data("BatteryMCc(累计充电次数)："+BatteryCc);
        dataList.add(data12);
        Data data13=new Data("BatterySeq(更新序列号)："+BatterySeq);
        dataList.add(data13);
        Data data14=new Data("BatteryAverage(平均电流)："+BatteryAverage);
        dataList.add(data14);
        Data data15=new Data("BatteryNow(瞬时电流)："+BatteryNow);
        dataList.add(data15);
    }
